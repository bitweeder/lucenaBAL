...
GTEST_TEST (lbalTest, Validation)
{
	...
	*/
	...
	LBAL_DIAGNOSTIC_TEST(LBAL_CPP2A_IMPL_COROUTINE);
	...
	LBAL_DIAGNOSTIC_TEST(LBAL_LIBCPP2A_CONCEPTS_BOOLEAN_TESTABLE);
	...
	LBAL_DIAGNOSTIC_TEST(LBAL_LIBCPP2A_COROUTINE);
	LBAL_DIAGNOSTIC_TEST(LBAL_LIBCPP2A_COROUTINE_EXP);
	...
	LBAL_DIAGNOSTIC_TEST(LBAL_LIBCPP2A_ERASE_IF_FREE_FUNCTIONS);
	...
	LBAL_DIAGNOSTIC_TEST(LBAL_LIBCPP2A_SMART_PTR_FOR_OVERWRITE);
	...
	LBAL_DIAGNOSTIC_TEST(LBAL_LIBCPP2A_SPAN_FIXED_SIZE);
	LBAL_DIAGNOSTIC_TEST(LBAL_LIBCPP2A_SSIZE);
