...
GTEST_TEST (lbalTest, Validation)
{
	...
	*/
	...
	LBAL_DIAGNOSTIC_TEST(LBAL_CPP2A_CLASS_TYPES_AS_NON_TYPE_TEMPLATE_PARAMETERS);
	#if LBAL_DIAGNOSTIC_COMPILE_TIME_REPORTING && !LBAL_CPP2A_CLASS_TYPES_AS_NON_TYPE_TEMPLATE_PARAMETERS
		#warning "LBAL_CPP2A_CLASS_TYPES_AS_NON_TYPE_TEMPLATE_PARAMETERS is UNSUPPORTED"
	#endif
...
//	LBAL_DIAGNOSTIC_TEST(LBAL_CPP2A_ATTRIBUTE_ASSERT);
//	#if LBAL_DIAGNOSTIC_COMPILE_TIME_REPORTING && !LBAL_CPP2A_ATTRIBUTE_ASSERT
//		#warning "LBAL_CPP2A_ATTRIBUTE_ASSERT is UNSUPPORTED"
//	#endif
//
//	LBAL_DIAGNOSTIC_TEST(LBAL_CPP2A_ATTRIBUTE_ENSURES);
//	#if LBAL_DIAGNOSTIC_COMPILE_TIME_REPORTING && !LBAL_CPP2A_ATTRIBUTE_ENSURES
//		#warning "LBAL_CPP2A_ATTRIBUTE_ENSURES is UNSUPPORTED"
//	#endif
//
//	LBAL_DIAGNOSTIC_TEST(LBAL_CPP2A_ATTRIBUTE_EXPECTS);
//	#if LBAL_DIAGNOSTIC_COMPILE_TIME_REPORTING && !LBAL_CPP2A_ATTRIBUTE_EXPECTS
//		#warning "LBAL_CPP2A_ATTRIBUTE_EXPECTS is UNSUPPORTED"
//	#endif
//
...
//	LBAL_DIAGNOSTIC_TEST(LBAL_CPP2A_CONTRACTS);
//	#if LBAL_DIAGNOSTIC_COMPILE_TIME_REPORTING && !LBAL_CPP2A_CONTRACTS
//		#warning "LBAL_CPP2A_CONTRACTS is UNSUPPORTED"
//	#endif
