...
// SEEME - bitweeder
//	It would be helpful to show the current version numbers in the docs, but
//	since they’re coming from a CMake-generated file, they don’t appear to be
//	accessible to Doxygen during preprocessing.
...
*/
#define LBAL_version                                                           \
  (LBAL_version_major << 24 | LBAL_version_minor << 16 | LBAL_version_patch)
...
///@cond LBAL_INTERNAL
#define LBAL_Concat1_(LBAL_base_, LBAL_suffix_) LBAL_base_##LBAL_suffix_
///@endcond
...
/**
  ...
  @remarks (SEEME - bitweeder) Microsoft Visual Studio stopped setting
  __cplusplus in the expected manner, but replaced the utility of it with a
  proprietary macro, `_MSVC_LANG`. We use it as an analog. Note that
  `_MSVC_LANG` is not available prior to MSVS 2015 Update 3.
*/
...
/**
  ...
  @remarks (SEEME - bitweeder) Because alterations to this are effectively
  viral, it is strongly recommended to only change this globally, and to be
  very through about it. It is even better to not change it at all, and instead
  provide new implementation file with appropriate special cases to avoid nasty
...
/**
  ...
  @remarks (APIME) Note that there doesn’t appear to be a way to ensure that the
  namespace scope macros are invoked correctly, e.g., guard values to keep from
  accidentally exiting the incorrect namespace.
...
*/
#define LBAL_abi_namespace LBAL_Concat_(bal_, LBAL_abi_version)
...
/**
  ...
  @remarks (SEEME - bitweeder) Because of how C++ namespaces work, it may not
  be immediately obvious if this has been used incorrectly. Generally, this
  should be a non-issue since this token should not appear in client code.
*/
#define LBAL_begin_namespace namespace lucena::bal {
...
/**
  ...
  should be a non-issue since this token should not appear in client code.
*/
#define LBAL_enter_v_namespace inline namespace LBAL_abi_namespace {
...
*/
#define LBAL_begin_v_namespace LBAL_begin_namespace LBAL_enter_v_namespace
...
/**
  ...
  should be a non-issue since this token should not appear in client code.
*/
#define LBAL_end_v_namespace LBAL_exit_v_namespace LBAL_end_namespace
...
*/
#define LBAL_v_ ::lucena::bal::LBAL_abi_namespace

//	Bring our namespace into existence.
LBAL_begin_v_namespace LBAL_end_v_namespace
...
*/
  ...
  #define LBAL_std std
    ...
    /**
      ...
      SEEME - bitweeder
      This is unused as of lucenaBAL 2.
    */
