...
//	This duplicates the test peformed to include this file in the first place.
    ...
    #define LBAL_NAME_TARGET_OS                                                \
      u8"FreeBSD version " LBAL_Stringify_(__FreeBSD__)
  #elif defined(__NetBSD__)
    #define LBAL_NAME_TARGET_OS u8"NetBSD version " LBAL_Stringify_(__NetBSD__)
  #elif defined(__OpenBSD__)
    #define LBAL_NAME_TARGET_OS                                                \
      u8"OpenBSD version " LBAL_Stringify_(__OpenBSD__)
  #elif defined(__DragonFly__)
    #define LBAL_NAME_TARGET_OS                                                \
      u8"DragonFly version " LBAL_Stringify_(__DragonFly__)
  #else
    #error                                                                     \
        "Unknown LBAL_TARGET_OS_X11 variant; update details/lbalPlatformSetup.hpp"
  #endif
#else
