...
#error "Don’t define LBAL_CPP17_xxx externally."
	...
	defined (LBAL_CPP2A_ATTRIBUTE_NODISCARD_EXPANDED) || \
	...
	defined (LBAL_CPP2A_CONCEPTS_RESPECIFY_RETURN_TYPE_REQUIREMENTS) || \
	defined (LBAL_CPP2A_CONCEPTS_REFINE_RETURN_TYPE_REQUIREMENTS) || \
	defined (LBAL_CPP2A_CONDITIONAL_EXPLICIT) || \
	defined (LBAL_CPP2A_CONST_REF_QUALIFIED_POINTERS_TO_MEMBERS) || \
	defined (LBAL_CPP2A_CONSTEVAL) || \
	defined (LBAL_CPP2A_CONSTEXPR_DYNAMIC_ALLOC) || \
	defined (LBAL_CPP2A_CONSTEXPR_DYNAMIC_POLYMORPHISM) || \
	defined (LBAL_CPP2A_CONSTEXPR_IN_DECLTYPE) || \
	defined (LBAL_CPP2A_CONSTEXPR_INTRINSICS) || \
	defined (LBAL_CPP2A_CONSTEXPR_TRIVIAL_DEFAULT_INITIALIZATION) || \
	defined (LBAL_CPP2A_CONSTEXPR_TRY_CATCH) || \
	defined (LBAL_CPP2A_CONSTEXPR_UNION_ALTERATION) || \
	...
	defined (LBAL_CPP2A_GENERIC_LAMBDAS_TEMPLATE_PARAMETER_LIST) || \
	defined (LBAL_CPP2A_IMPL_COROUTINE) || \
	defined (LBAL_CPP2A_INIT_CAPTURES_PACK_EXPANSION) || \
	...
	defined (LBAL_CPP2A_NONTYPE_TEMPLATE_ARGS_FIXES) || \
	defined (LBAL_CPP2A_NONTYPE_TEMPLATE_PARAMETER_CLASS) || \
	defined (LBAL_CPP2A_THREE_WAY_COMPARISON_OPERATOR) || \
	defined (LBAL_CPP2A_THREE_WAY_COMPARISON_OPERATOR_EQUALITY_FIX) || \
