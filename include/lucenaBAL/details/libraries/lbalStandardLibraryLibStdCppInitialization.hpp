...
*/
  ...
  #if (__GNUC__ >= 8)
    //	SEEME - bitweeder
    //	Only ints are supported; floats are forthcoming. libstdc++ might be a
...
#else
  #error                                                                       \
      "lbalStandardLibraryLibStdCppInitialization.hpp was directly included with the incorrect Standard Library implementation"
#endif
