...
*/
  ...
  //	here.
      ...
      //	Not in `<version>` as of 1924
        ...
        #define LBAL_LIBCPP20_IS_NOTHROW_CONVERTIBLE 201806L
      ...
      //	Not in `<version>` as of 1924
        ...
        #define LBAL_LIBCPP20_CONCEPTS_STANDARD_CASE 201907L
...
#else
  #error                                                                       \
      "lbalStandardLibraryMSVCPostInitialization.hpp was directly included with the incorrect Standard Library implementation"
#endif
