...
//	C++20 features
  ...
  //	and a language test. This will miss back-ported extensions, but will
  //	pick up preview implementations.
    ...
    //	SEEME - bitweeder
    //	There is no SD-6 token for this.
    #if !defined(                                                              \
...
#else
  #error                                                                       \
      "lbalClangPostInitialization.hpp was directly included while using the wrong compiler"
#endif
