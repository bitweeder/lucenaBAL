...
*/
  ...
  #elif defined(__i386__)  //	 or defined (__i486__) or defined (__i586__) or
                           // defined (__i686__)
  ...
  //	SEEME - bitweeder
  //	Architecture is the same across Linux derivatives (ignoring old a.out),
  //	but binary compatibility is not guaranteed.
  #if defined(__ELF__)
  ...
  //	macro, as otherwise there’s no way to detect it.
...
//	C++20 features
  ...
  #define LBAL_VIS_MEMBER_FUNCTION_TEMPLATE                                    \
    __attribute__((__visibility__("hidden")))
//	FIXME - bitweeder
//	There is a clang defect which requires an extraneous “inline”
...
#else
  #error                                                                       \
      "lbalGCCInitialization.hpp was directly included while using the wrong compiler"
#endif
