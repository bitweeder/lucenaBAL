...
//	This duplicates the test peformed to include this file in the first place.
	...
	#elif (LBAL_CONFIG_cpp_version >= 201402L) && (_MSC_VER >= 1900)
	...
	#elif (LBAL_CONFIG_cpp_version >= 201402L) && (_MSC_VER >= 1910)
	...
	#elif (LBAL_CONFIG_cpp_version >= 201703L) &&  (_MSC_VER >= 1914)
		#define LBAL_CPP17_AGGREGATE_BASES 201603L
	#endif

	#if (__cpp_aligned_new >= 201606L)
		#define LBAL_CPP17_ALIGNED_NEW __cpp_aligned_new
	#elif (LBAL_CONFIG_cpp_version >= 201703L) && (_MSC_VER >= 1912)
	...
	#elif (LBAL_CONFIG_cpp_version >= 201703L) && (_MSC_VER >= 1911)
	...
	#elif (LBAL_CONFIG_cpp_version >= 201703L) && (_MSC_VER >= 1900)
	...
	#elif (LBAL_CONFIG_cpp_version >= 201703L) && (_MSC_VER >= 1913)
	...
	#elif (LBAL_CONFIG_cpp_version >= 201703L) && (_MSC_VER >= 1910)
