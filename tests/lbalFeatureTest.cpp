...
GTEST_TEST(lbalTest, Validation) {
  ...
  */
  ...
  //  SEEME
  //  We don’t test for this since it was removed in C++23 and was never really
  ...
  //  SEEME
  //  We don’t test for this since it was only ever intended to be a
  //  placeholder, and has nothing to do with Standard compliance.
